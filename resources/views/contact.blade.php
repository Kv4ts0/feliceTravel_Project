...
<body>
    <div class="parent_section tourParent">
        ...
        <div class="flexBox flexSection">
            <div class="mainDesc">
                <h1>Keep in Touch with Felice Travel</h1>
                <p>At Felice Travel, we believe in creating lasting connections beyond the journey. Stay informed, inspired, and ready for your next adventure by keeping in touch with us. Here's how:</p>
                <div>
                    <p>
                        <i class="fa-brands fa-whatsapp" style="color: #ffd43b;"></i> +995 558 38 28 61 
                    </p>
                    <p>
                        <i class="fa-solid fa-envelope" style="color: #ffd43b;"></i> felicetravelgeorgia@gmail.com
                    </p>
                    <p>
                        <i class="fa-solid fa-location-arrow" style="color: #ffd43b;"></i> Didube Plaza, 116 Akaki Tsereteli Ave, Tbilisi, Georgia
                    </p>
                </div>
    ...
    <div class="contactForm">
        <div class="fillForm">
            ...
            <textarea name="usertext" id="usertext" cols="30" rows="20" placeholder="Enter your text there"></textarea>
    ...
    <footer>
        ...
        <nav>
            <ul>
                ...
                <a href="/contact"><li id="active">Contact</li></a>
            </ul>
        </nav>
        <div class="social">
